...
GM.SecondsBetweenTeamSwitches = 30	// The minimum time between each team change?
...
GM.ForceJoinBalancedTeams = GetGlobalBool("bJoinBalancedTeam", true)	// Players won't be allowed to join a team if it has more players than another team
