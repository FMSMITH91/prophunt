...
L["PHXM_ADMIN_REWSPANTIMEPERCENT"]		= "Porcentaje de la cuenta atrás en que se puede reaparecer. Por defecto: 0,75 (equivale al 75%)."
...
-- Machine-translated, not reviewed by a native speaker: corrections welcome.

L["DERMA_BAN_1DAY"]	= "1 día"
L["DERMA_BAN_1HOUR"]	= "1 hora"
L["DERMA_BAN_1WEEK"]	= "1 semana"
L["DERMA_BAN_30MIN"]	= "30 minutos"
L["DERMA_BAN_5MIN"]	= "5 minutos"
L["DERMA_BAN_PERMA"]	= "Permanente"
L["DERMA_MENU_BAN"]	= "Banear"
L["DERMA_MENU_BAN_TITLE"]	= "Banear a %s (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "¿Banear a %s durante %s?"
L["DERMA_MENU_CONFIRM_KICK"]	= "¿Expulsar a %s?"
L["DERMA_MENU_COPYID"]	= "Copiar SteamID"
L["DERMA_MENU_CUSTOM_REASON"]	= "Motivo personalizado..."
L["DERMA_MENU_GAG"]	= "Silenciar (voz)"
L["DERMA_MENU_HINT"]	= "Haz clic derecho en un jugador para ver las opciones"
L["DERMA_MENU_KICK"]	= "Expulsar"
L["DERMA_MENU_KICK_TITLE"]	= "Expulsar a %s"
L["DERMA_MENU_MUTE"]	= "Silenciar (chat de texto)"
L["DERMA_MENU_MUTE_ME"]	= "Silenciar solo para mí"
L["DERMA_MENU_NO"]	= "No"
L["DERMA_MENU_PROFILE"]	= "Abrir perfil de Steam"
L["DERMA_MENU_REASON"]	= "Motivo:"
L["DERMA_MENU_UNGAG"]	= "Quitar silencio (voz)"
L["DERMA_MENU_UNMUTE"]	= "Quitar silencio (chat de texto)"
L["DERMA_MENU_UNMUTE_ME"]	= "Quitar silencio solo para mí"
L["DERMA_MENU_YES"]	= "Sí"
L["DERMA_OPEN_STEAM_PROFILE"]	= "Haz clic para abrir el perfil de Steam de este jugador"
L["DERMA_PLAYERS_ONE"]	= "(%d jugador)"
L["FORCEH2P_ALREADY"]	= "%s ya está asignado como Prop para la próxima ronda."
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[SIN CAZADORES]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "¡No hay Cazadores, caramba, está escrito en el botón!"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "Desmarca la casilla anterior para acceder a las opciones avanzadas de equilibrio de equipos."
L["PHXM_MV_CANCEL"]	= "Cancelar votación"
L["PHXM_MV_HINT"]	= "Haz clic en un mapa para votar. Puedes cambiar de opinión."
L["PHXM_MV_TALLY"]	= "%d / %d han votado"
L["PHXM_MV_TITLE"]	= "Vota por el siguiente mapa"
L["PHXM_MV_WINNER"]	= "Siguiente mapa"
L["PHXM_TAUNT_DOOVERLAP"]	= "¿Deben las burlas en curso superponerse con una nueva?\nDesactivarlo detiene la actual y reproduce la nueva. Activarlo mantiene el comportamiento clásico."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "¿Incluir las burlas predeterminadas de PH:X y la carpeta del Taunt Scanner?\nSi se desactiva, solo se usarán burlas personalizadas; si no hay ninguna, se usarán sonidos de reserva (REQUIERE REINICIAR EL MAPA)"
L["PHXM_TAUNT_SNDLVL"]	= "Nivel de sonido de las burlas\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (por defecto es 6)"
