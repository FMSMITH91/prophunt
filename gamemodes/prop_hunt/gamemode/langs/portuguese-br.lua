...
L["DERMA_MENU_BAN"]	= "Banir"
L["DERMA_MENU_BAN_TITLE"]	= "Banir %s (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "Banir %s por %s?"
L["DERMA_MENU_CONFIRM_KICK"]	= "Expulsar %s?"
L["DERMA_MENU_COPYID"]	= "Copiar SteamID"
L["DERMA_MENU_CUSTOM_REASON"]	= "Motivo personalizado..."
L["DERMA_MENU_GAG"]	= "Silenciar (voz)"
L["DERMA_MENU_HINT"]	= "Clique com o botão direito num jogador para ver as opções"
L["DERMA_MENU_KICK"]	= "Expulsar"
L["DERMA_MENU_KICK_TITLE"]	= "Expulsar %s"
L["DERMA_MENU_MUTE"]	= "Silenciar (chat de texto)"
L["DERMA_MENU_MUTE_ME"]	= "Silenciar só para mim"
L["DERMA_MENU_NO"]	= "Não"
L["DERMA_MENU_PROFILE"]	= "Abrir perfil Steam"
L["DERMA_MENU_REASON"]	= "Motivo:"
L["DERMA_MENU_UNGAG"]	= "Remover silêncio (voz)"
L["DERMA_MENU_UNMUTE"]	= "Remover silêncio (chat de texto)"
L["DERMA_MENU_UNMUTE_ME"]	= "Remover silêncio só para mim"
L["DERMA_MENU_YES"]	= "Sim"
L["DERMA_OPEN_STEAM_PROFILE"]	= "Clique para abrir o perfil Steam deste jogador"
L["DERMA_PLAYERS_ONE"]	= "(%d jogador)"
L["FORCEH2P_ALREADY"]	= "%s já foi definido como Prop para a próxima rodada."
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[SEM CAÇADORES]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "Não há Caçadores, caramba, está escrito no botão!"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "Desmarque a caixa anterior para acessar as opções avançadas de equilíbrio de equipes."
L["PHXM_MV_CANCEL"]	= "Cancelar votação"
L["PHXM_MV_HINT"]	= "Clique num mapa para votar. Pode mudar de ideia."
L["PHXM_MV_TALLY"]	= "%d / %d votaram"
L["PHXM_MV_TITLE"]	= "Vote no próximo mapa"
L["PHXM_MV_WINNER"]	= "Próximo mapa"
L["PHXM_TAUNT_DOOVERLAP"]	= "As provocações em reprodução devem se sobrepor a uma nova?\nDesativar para a atual e reproduz a nova. Ativar mantém o comportamento clássico."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "Incluir as provocações padrão do PH:X e a pasta do Taunt Scanner?\nSe desativado, apenas provocações personalizadas serão usadas; sem elas, sons reserva são tocados (EXIGE REINÍCIO DO MAPA)"
L["PHXM_TAUNT_SNDLVL"]	= "Nível de som das provocações\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (padrão é 6)"
