...
L["DERMA_BAN_1HOUR"]	= "1 小時"
L["DERMA_BAN_1WEEK"]	= "1 週"
L["DERMA_BAN_30MIN"]	= "30 分鐘"
L["DERMA_BAN_5MIN"]	= "5 分鐘"
L["DERMA_BAN_PERMA"]	= "永久"
L["DERMA_MENU_BAN"]	= "封鎖"
L["DERMA_MENU_BAN_TITLE"]	= "封鎖 %s (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "確定封鎖 %s %s 嗎？"
L["DERMA_MENU_CONFIRM_KICK"]	= "確定踢出 %s 嗎？"
L["DERMA_MENU_COPYID"]	= "複製 SteamID"
L["DERMA_MENU_CUSTOM_REASON"]	= "自訂理由..."
L["DERMA_MENU_GAG"]	= "禁言（語音）"
L["DERMA_MENU_HINT"]	= "右鍵點擊玩家可查看選項"
L["DERMA_MENU_KICK"]	= "踢出"
L["DERMA_MENU_KICK_TITLE"]	= "踢出 %s"
L["DERMA_MENU_MUTE"]	= "禁言（文字聊天）"
L["DERMA_MENU_MUTE_ME"]	= "僅對我禁言"
L["DERMA_MENU_NO"]	= "否"
L["DERMA_MENU_PROFILE"]	= "開啟 Steam 個人檔案"
L["DERMA_MENU_REASON"]	= "理由："
L["DERMA_MENU_UNGAG"]	= "解除禁言（語音）"
L["DERMA_MENU_UNMUTE"]	= "解除禁言（文字聊天）"
L["DERMA_MENU_UNMUTE_ME"]	= "僅對我解除禁言"
L["DERMA_MENU_YES"]	= "是"
L["DERMA_OPEN_STEAM_PROFILE"]	= "點擊開啟該玩家的 Steam 個人檔案"
L["DERMA_PLAYERS_ONE"]	= "（%d 名玩家）"
L["FORCEH2P_ALREADY"]	= "%s 已被指定為下一回合的道具。"
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[沒有獵人]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "根本沒有獵人啊，按鈕上都寫著呢！"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "取消勾選上一個選項即可使用進階隊伍平衡設定。"
L["PHXM_MV_CANCEL"]	= "取消投票"
L["PHXM_MV_HINT"]	= "點擊地圖進行投票，可以隨時更改。"
L["PHXM_MV_TALLY"]	= "%d / %d 已投票"
L["PHXM_MV_TITLE"]	= "投票選擇下一張地圖"
L["PHXM_MV_WINNER"]	= "下一張地圖"
L["PHXM_TAUNT_DOOVERLAP"]	= "正在播放的嘲諷是否應與新嘲諷重疊？\n關閉會停止目前嘲諷並播放新的，開啟則保持經典行為。"
L["PHXM_TAUNT_INCLUDE_DEF"]	= "是否包含 PH:X 預設嘲諷與 Taunt Scanner 目錄？\n關閉後僅使用自訂嘲諷；若沒有自訂嘲諷，則使用備用音效（需要重啟地圖）"
L["PHXM_TAUNT_SNDLVL"]	= "嘲諷音量等級\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB（預設為 6）"
