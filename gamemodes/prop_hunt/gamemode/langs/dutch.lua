...
L["DERMA_BAN_1DAY"]	= "1 dag"
L["DERMA_BAN_1HOUR"]	= "1 uur"
L["DERMA_BAN_1WEEK"]	= "1 week"
L["DERMA_BAN_30MIN"]	= "30 minuten"
L["DERMA_BAN_5MIN"]	= "5 minuten"
L["DERMA_BAN_PERMA"]	= "Permanent"
L["DERMA_MENU_BAN"]	= "Verbannen"
L["DERMA_MENU_BAN_TITLE"]	= "%s bannen (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "%s verbannen voor %s?"
L["DERMA_MENU_CONFIRM_KICK"]	= "%s kicken?"
L["DERMA_MENU_COPYID"]	= "SteamID kopiëren"
L["DERMA_MENU_CUSTOM_REASON"]	= "Eigen reden..."
L["DERMA_MENU_GAG"]	= "Dempen (spraak)"
L["DERMA_MENU_HINT"]	= "Klik rechts op een speler voor opties"
L["DERMA_MENU_KICK"]	= "Kicken"
L["DERMA_MENU_KICK_TITLE"]	= "%s kicken"
L["DERMA_MENU_MUTE"]	= "Dempen (tekstchat)"
L["DERMA_MENU_MUTE_ME"]	= "Dempen voor mij"
L["DERMA_MENU_NO"]	= "Nee"
L["DERMA_MENU_PROFILE"]	= "Steam-profiel openen"
L["DERMA_MENU_REASON"]	= "Reden:"
L["DERMA_MENU_UNGAG"]	= "Dempen opheffen (spraak)"
L["DERMA_MENU_UNMUTE"]	= "Dempen opheffen (tekstchat)"
L["DERMA_MENU_UNMUTE_ME"]	= "Dempen opheffen voor mij"
L["DERMA_MENU_YES"]	= "Ja"
L["DERMA_OPEN_STEAM_PROFILE"]	= "Klik om het Steam-profiel van deze speler te openen"
L["DERMA_PLAYERS_ONE"]	= "(%d speler)"
L["FORCEH2P_ALREADY"]	= "%s is al aangewezen als Prop voor de volgende ronde."
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[GEEN ZOEKERS]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "Er zijn verdorie geen Zoekers, het staat op de knop!"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "Vink het vorige vakje uit om de geavanceerde opties voor teambalans te gebruiken."
L["PHXM_MV_CANCEL"]	= "Stemming annuleren"
L["PHXM_MV_HINT"]	= "Klik op een map om te stemmen. Je kunt je stem nog wijzigen."
L["PHXM_MV_TALLY"]	= "%d / %d gestemd"
L["PHXM_MV_TITLE"]	= "Stem op de volgende map"
L["PHXM_MV_WINNER"]	= "Volgende map"
L["PHXM_TAUNT_DOOVERLAP"]	= "Moeten lopende taunts overlappen met een nieuwe taunt?\nUitschakelen stopt de huidige en speelt de nieuwe af. Inschakelen behoudt het klassieke gedrag."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "Standaard PH:X-taunts en de Taunt Scanner-map meenemen?\nIs dit uitgeschakeld, dan worden alleen aangepaste taunts gebruikt; zijn die er niet, dan wordt teruggevallen op standaardgeluiden (VEREIST MAPHERSTART)"
L["PHXM_TAUNT_SNDLVL"]	= "Geluidsniveau van taunts\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (standaard is 6)"
