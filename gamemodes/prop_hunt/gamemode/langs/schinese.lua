...
L["DERMA_BAN_1DAY"]	= "1 天"
L["DERMA_BAN_1HOUR"]	= "1 小时"
L["DERMA_BAN_1WEEK"]	= "1 周"
L["DERMA_BAN_30MIN"]	= "30 分钟"
L["DERMA_BAN_5MIN"]	= "5 分钟"
L["DERMA_BAN_PERMA"]	= "永久"
L["DERMA_MENU_BAN"]	= "封禁"
L["DERMA_MENU_BAN_TITLE"]	= "封禁 %s (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "确定封禁 %s %s 吗？"
L["DERMA_MENU_CONFIRM_KICK"]	= "确定踢出 %s 吗？"
L["DERMA_MENU_COPYID"]	= "复制 SteamID"
L["DERMA_MENU_CUSTOM_REASON"]	= "自定义理由..."
L["DERMA_MENU_GAG"]	= "禁言（语音）"
L["DERMA_MENU_HINT"]	= "右键点击玩家可查看选项"
L["DERMA_MENU_KICK"]	= "踢出"
L["DERMA_MENU_KICK_TITLE"]	= "踢出 %s"
L["DERMA_MENU_MUTE"]	= "禁言（文字聊天）"
L["DERMA_MENU_MUTE_ME"]	= "仅对我禁言"
L["DERMA_MENU_NO"]	= "否"
L["DERMA_MENU_PROFILE"]	= "打开 Steam 个人资料"
L["DERMA_MENU_REASON"]	= "理由："
L["DERMA_MENU_UNGAG"]	= "解除禁言（语音）"
L["DERMA_MENU_UNMUTE"]	= "解除禁言（文字聊天）"
L["DERMA_MENU_UNMUTE_ME"]	= "仅对我解除禁言"
L["DERMA_MENU_YES"]	= "是"
L["DERMA_OPEN_STEAM_PROFILE"]	= "点击打开该玩家的 Steam 个人资料"
L["DERMA_PLAYERS_ONE"]	= "（%d 名玩家）"
L["FORCEH2P_ALREADY"]	= "%s 已被指定为下一回合的道具。"
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[没有猎人]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "根本没有猎人啊，按钮上都写着呢！"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "取消勾选上一个选项即可使用高级队伍平衡设置。"
L["PHXM_MV_CANCEL"]	= "取消投票"
L["PHXM_MV_HINT"]	= "点击地图进行投票，可以随时更改。"
L["PHXM_MV_TALLY"]	= "%d / %d 已投票"
L["PHXM_MV_TITLE"]	= "投票选择下一张地图"
L["PHXM_MV_WINNER"]	= "下一张地图"
L["PHXM_TAUNT_DOOVERLAP"]	= "正在播放的嘲讽是否应与新嘲讽重叠？\n关闭会停止当前嘲讽并播放新的，开启则保持经典行为。"
L["PHXM_TAUNT_INCLUDE_DEF"]	= "是否包含 PH:X 默认嘲讽与 Taunt Scanner 目录？\n关闭后仅使用自定义嘲讽；若没有自定义嘲讽，则使用备用音效（需要重启地图）"
L["PHXM_TAUNT_SNDLVL"]	= "嘲讽音量等级\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB（默认为 6）"
