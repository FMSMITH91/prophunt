...
L["DERMA_BAN_1DAY"]	= "1 dzień"
L["DERMA_BAN_1HOUR"]	= "1 godzina"
L["DERMA_BAN_1WEEK"]	= "1 tydzień"
L["DERMA_BAN_30MIN"]	= "30 minut"
L["DERMA_BAN_5MIN"]	= "5 minut"
L["DERMA_BAN_PERMA"]	= "Na stałe"
L["DERMA_MENU_BAN"]	= "Zbanuj"
L["DERMA_MENU_BAN_TITLE"]	= "Zbanuj %s (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "Zbanować %s na %s?"
L["DERMA_MENU_CONFIRM_KICK"]	= "Wyrzucić %s?"
L["DERMA_MENU_COPYID"]	= "Kopiuj SteamID"
L["DERMA_MENU_CUSTOM_REASON"]	= "Własny powód..."
L["DERMA_MENU_GAG"]	= "Ucisz (głos)"
L["DERMA_MENU_HINT"]	= "Kliknij gracza prawym przyciskiem, aby zobaczyć opcje"
L["DERMA_MENU_KICK"]	= "Wyrzuć"
L["DERMA_MENU_KICK_TITLE"]	= "Wyrzuć %s"
L["DERMA_MENU_MUTE"]	= "Wycisz (czat tekstowy)"
L["DERMA_MENU_MUTE_ME"]	= "Wycisz dla mnie"
L["DERMA_MENU_NO"]	= "Nie"
L["DERMA_MENU_PROFILE"]	= "Otwórz profil Steam"
L["DERMA_MENU_REASON"]	= "Powód:"
L["DERMA_MENU_UNGAG"]	= "Cofnij uciszenie (głos)"
L["DERMA_MENU_UNMUTE"]	= "Cofnij wyciszenie (czat tekstowy)"
L["DERMA_MENU_UNMUTE_ME"]	= "Cofnij wyciszenie dla mnie"
L["DERMA_MENU_YES"]	= "Tak"
L["DERMA_OPEN_STEAM_PROFILE"]	= "Kliknij, aby otworzyć profil Steam tego gracza"
L["DERMA_PLAYERS_ONE"]	= "(%d gracz)"
L["FORCEH2P_ALREADY"]	= "%s jest już wyznaczony jako Prop na następną rundę."
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[BRAK ŁOWCÓW]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "Nie ma żadnych Łowców, przecież jest to napisane na przycisku!"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "Odznacz poprzednie pole, aby uzyskać dostęp do zaawansowanych opcji balansu drużyn."
L["PHXM_MV_CANCEL"]	= "Anuluj głosowanie"
L["PHXM_MV_HINT"]	= "Kliknij mapę, aby zagłosować. Możesz zmienić zdanie."
L["PHXM_MV_TALLY"]	= "Zagłosowało %d / %d"
L["PHXM_MV_TITLE"]	= "Zagłosuj na następną mapę"
L["PHXM_MV_WINNER"]	= "Następna mapa"
L["PHXM_TAUNT_DOOVERLAP"]	= "Czy odtwarzane taunty mają nakładać się na nowy taunt?\nWyłączenie zatrzymuje bieżący i odtwarza nowy. Włączenie zachowuje klasyczne zachowanie."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "Dołączyć domyślne taunty PH:X i katalog Taunt Scannera?\nPo wyłączeniu używane będą tylko własne taunty, a przy ich braku dźwięki zapasowe (WYMAGA RESTARTU MAPY)"
L["PHXM_TAUNT_SNDLVL"]	= "Poziom głośności tauntów\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (domyślnie 6)"
