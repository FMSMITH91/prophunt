...
L["DERMA_BAN_1DAY"]	= "1일"
L["DERMA_BAN_1HOUR"]	= "1시간"
L["DERMA_BAN_1WEEK"]	= "1주"
L["DERMA_BAN_30MIN"]	= "30분"
L["DERMA_BAN_5MIN"]	= "5분"
L["DERMA_BAN_PERMA"]	= "영구"
L["DERMA_MENU_BAN"]	= "차단"
L["DERMA_MENU_BAN_TITLE"]	= "%s 차단 (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "%s 님을 %s 동안 차단할까요?"
L["DERMA_MENU_CONFIRM_KICK"]	= "%s 님을 추방할까요?"
L["DERMA_MENU_COPYID"]	= "SteamID 복사"
L["DERMA_MENU_CUSTOM_REASON"]	= "직접 입력..."
L["DERMA_MENU_GAG"]	= "음성 차단"
L["DERMA_MENU_HINT"]	= "플레이어를 우클릭하면 옵션이 표시됩니다"
L["DERMA_MENU_KICK"]	= "추방"
L["DERMA_MENU_KICK_TITLE"]	= "%s 추방"
L["DERMA_MENU_MUTE"]	= "채팅 차단"
L["DERMA_MENU_MUTE_ME"]	= "나에게만 차단"
L["DERMA_MENU_NO"]	= "아니요"
L["DERMA_MENU_PROFILE"]	= "Steam 프로필 열기"
L["DERMA_MENU_REASON"]	= "사유:"
L["DERMA_MENU_UNGAG"]	= "음성 차단 해제"
L["DERMA_MENU_UNMUTE"]	= "채팅 차단 해제"
L["DERMA_MENU_UNMUTE_ME"]	= "나에게만 차단 해제"
L["DERMA_MENU_YES"]	= "예"
L["DERMA_OPEN_STEAM_PROFILE"]	= "클릭하면 이 플레이어의 Steam 프로필이 열립니다"
L["DERMA_PLAYERS_ONE"]	= "(%d명)"
L["PHXM_MV_CANCEL"]	= "투표 취소"
L["PHXM_MV_HINT"]	= "맵을 클릭해 투표하세요. 언제든 바꿀 수 있습니다."
L["PHXM_MV_TALLY"]	= "%d / %d 투표함"
L["PHXM_MV_TITLE"]	= "다음 맵 투표"
L["PHXM_MV_WINNER"]	= "다음 맵"
L["PHXM_TAUNT_DOOVERLAP"]	= "재생 중인 도발이 새 도발과 겹치도록 할까요?\n비활성화하면 기존 도발을 멈추고 새 도발을 재생합니다. 활성화하면 기존 방식이 유지됩니다."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "PH:X 기본 도발과 Taunt Scanner 폴더를 포함할까요?\n비활성화하면 사용자 도발만 사용하며, 없을 경우 대체 사운드를 사용합니다 (맵 재시작 필요)"
L["PHXM_TAUNT_SNDLVL"]	= "도발 음량 레벨\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (기본값 6)"
