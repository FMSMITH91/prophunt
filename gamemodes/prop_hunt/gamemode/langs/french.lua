...
L["DERMA_BAN_1DAY"]	= "1 jour"
L["DERMA_BAN_1HOUR"]	= "1 heure"
L["DERMA_BAN_1WEEK"]	= "1 semaine"
L["DERMA_BAN_30MIN"]	= "30 minutes"
L["DERMA_BAN_5MIN"]	= "5 minutes"
L["DERMA_BAN_PERMA"]	= "Permanent"
L["DERMA_MENU_BAN"]	= "Bannir"
L["DERMA_MENU_BAN_TITLE"]	= "Bannir %s (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "Bannir %s pendant %s ?"
L["DERMA_MENU_CONFIRM_KICK"]	= "Expulser %s ?"
L["DERMA_MENU_COPYID"]	= "Copier le SteamID"
L["DERMA_MENU_CUSTOM_REASON"]	= "Raison personnalisée..."
L["DERMA_MENU_GAG"]	= "Museler (vocal)"
L["DERMA_MENU_HINT"]	= "Clic droit sur un joueur pour les options"
L["DERMA_MENU_KICK"]	= "Expulser"
L["DERMA_MENU_KICK_TITLE"]	= "Expulser %s"
L["DERMA_MENU_MUTE"]	= "Muet (chat écrit)"
L["DERMA_MENU_MUTE_ME"]	= "Muet pour moi"
L["DERMA_MENU_NO"]	= "Non"
L["DERMA_MENU_PROFILE"]	= "Ouvrir le profil Steam"
L["DERMA_MENU_REASON"]	= "Raison :"
L["DERMA_MENU_UNGAG"]	= "Démuseler (vocal)"
L["DERMA_MENU_UNMUTE"]	= "Réactiver (chat écrit)"
L["DERMA_MENU_UNMUTE_ME"]	= "Réactiver pour moi"
L["DERMA_MENU_YES"]	= "Oui"
L["DERMA_OPEN_STEAM_PROFILE"]	= "Cliquez pour ouvrir le profil Steam de ce joueur"
L["DERMA_PLAYERS_ONE"]	= "(%d joueur)"
L["FORCEH2P_ALREADY"]	= "%s est déjà défini comme Prop pour la prochaine manche."
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[AUCUN HUNTER]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "Il n'y a aucun Hunter, bon sang, c'est écrit sur le bouton !"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "Décochez la case précédente pour accéder aux options avancées d'équilibrage des équipes."
L["PHXM_MV_CANCEL"]	= "Annuler le vote"
L["PHXM_MV_HINT"]	= "Cliquez sur une carte pour voter. Vous pouvez changer d'avis."
L["PHXM_MV_TALLY"]	= "%d / %d ont voté"
L["PHXM_MV_TITLE"]	= "Votez pour la prochaine carte"
L["PHXM_MV_WINNER"]	= "Prochaine carte"
L["PHXM_TAUNT_DOOVERLAP"]	= "Les taunts en cours doivent-ils se superposer à un nouveau taunt ?\nDésactiver arrête celui en cours et joue le nouveau. Activer conserve le comportement classique."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "Inclure les taunts PH:X par défaut et le dossier du Taunt Scanner ?\nSi désactivé, seuls les taunts personnalisés sont utilisés ; s'il n'y en a aucun, des sons de repli sont joués (REDÉMARRAGE DE LA CARTE REQUIS)"
L["PHXM_TAUNT_SNDLVL"]	= "Niveau sonore des taunts\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (par défaut : 6)"
