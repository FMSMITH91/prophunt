...
L["DERMA_BAN_1DAY"]	= "1 Tag"
L["DERMA_BAN_1HOUR"]	= "1 Stunde"
L["DERMA_BAN_1WEEK"]	= "1 Woche"
L["DERMA_BAN_30MIN"]	= "30 Minuten"
L["DERMA_BAN_5MIN"]	= "5 Minuten"
L["DERMA_BAN_PERMA"]	= "Permanent"
L["DERMA_MENU_BAN"]	= "Bannen"
L["DERMA_MENU_BAN_TITLE"]	= "%s bannen (%s)"
L["DERMA_MENU_CONFIRM_BAN"]	= "%s für %s bannen?"
L["DERMA_MENU_CONFIRM_KICK"]	= "%s kicken?"
L["DERMA_MENU_COPYID"]	= "SteamID kopieren"
L["DERMA_MENU_CUSTOM_REASON"]	= "Eigener Grund..."
L["DERMA_MENU_GAG"]	= "Stummschalten (Sprache)"
L["DERMA_MENU_HINT"]	= "Rechtsklick auf einen Spieler für Optionen"
L["DERMA_MENU_KICK"]	= "Kicken"
L["DERMA_MENU_KICK_TITLE"]	= "%s kicken"
L["DERMA_MENU_MUTE"]	= "Stummschalten (Textchat)"
L["DERMA_MENU_MUTE_ME"]	= "Für mich stummschalten"
L["DERMA_MENU_NO"]	= "Nein"
L["DERMA_MENU_PROFILE"]	= "Steam-Profil öffnen"
L["DERMA_MENU_REASON"]	= "Grund:"
L["DERMA_MENU_UNGAG"]	= "Stummschaltung aufheben (Sprache)"
L["DERMA_MENU_UNMUTE"]	= "Stummschaltung aufheben (Textchat)"
L["DERMA_MENU_UNMUTE_ME"]	= "Für mich Stummschaltung aufheben"
L["DERMA_MENU_YES"]	= "Ja"
L["DERMA_OPEN_STEAM_PROFILE"]	= "Klicken, um das Steam-Profil dieses Spielers zu öffnen"
L["DERMA_PLAYERS_ONE"]	= "(%d Spieler)"
L["FORCEH2P_ALREADY"]	= "%s ist bereits als Prop für die nächste Runde festgelegt."
L["PHXM_ADMIN_FORCEH2P_NOHUNT"]	= "[KEINE JÄGER]"
L["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"]	= "Es gibt verflixt nochmal keine Jäger, es steht doch auf dem Knopf!"
L["PHXM_ADMIN_TEAMBAL_UNCHECK"]	= "Deaktiviere das vorherige Kontrollkästchen, um die erweiterten Optionen zum Teamausgleich zu nutzen."
L["PHXM_MV_CANCEL"]	= "Abstimmung abbrechen"
L["PHXM_MV_HINT"]	= "Klicke auf eine Map, um abzustimmen. Du kannst deine Wahl ändern."
L["PHXM_MV_TALLY"]	= "%d / %d abgestimmt"
L["PHXM_MV_TITLE"]	= "Stimme für die nächste Map"
L["PHXM_MV_WINNER"]	= "Nächste Map"
L["PHXM_TAUNT_DOOVERLAP"]	= "Sollen laufende Taunts sich mit einem neuen Taunt überlagern?\nDeaktivieren stoppt den laufenden und spielt den neuen ab. Aktivieren behält das klassische Verhalten."
L["PHXM_TAUNT_INCLUDE_DEF"]	= "Standard-Taunts von PH:X und den Taunt-Scanner-Ordner einbeziehen?\nWenn deaktiviert, werden nur eigene Taunts verwendet; gibt es keine, werden Ersatzgeräusche abgespielt (MAP-NEUSTART ERFORDERLICH)"
L["PHXM_TAUNT_SNDLVL"]	= "Lautstärke der Taunts\n1=75dB 2=80dB 3=85dB 4=90dB 5=95dB 6=100dB (Standard ist 6)"
