...
PHX.VERSION		= "X"
PHX.REVISION	= "16.11.20" --Format: dd/mm/yy.
...
PHX.CVAR.AutoTauntEnable	= CreateConVar("ph_autotaunt_enabled", "0",CVAR_SERVER_ONLY_NO_NOTIFY, "Should auto taunting be enabled", 0, 1)
PHX.CVAR.AutoTauntDelay		= CreateConVar("ph_autotaunt_delay", "45", CVAR_SERVER_ONLY_NO_NOTIFY, "The delay for the auto taunt")
PHX.CVAR.CustomTauntMode	= CreateConVar("ph_custom_taunt_mode", "2", CVAR_SERVER_ONLY, "Enable custom taunts for prop teams by pressing C? (Default 0)\n  You must have a list of custom taunts to enable this.", 0, 2)
PHX.CVAR.CustomTauntDelay	= CreateConVar("ph_customtaunts_delay", "4", CVAR_SERVER_ONLY, "How many in seconds delay for props to play custom taunt again? (Default is 6)")
PHX.CVAR.NormalTauntDelay	= CreateConVar("ph_normal_taunt_delay", "4", CVAR_SERVER_ONLY, "How many in seconds delay for props to play normal [F3] taunt again? (Default is 2)")
...
PHX.CVAR.NotifyPlayerJoinLeaves = CreateConVar("ph_notify_player_join_leave", "0", CVAR_SERVER_ONLY, "Notify Player Join and Leave in the Chat?")
...
PHX.CVAR.HunterKillBonus	= CreateConVar("ph_hunter_kill_bonus", "20", CVAR_SERVER_ONLY, "How much health to give back to the Hunter after killing a prop.", 0, 500)
...
PHX.CVAR.WaitForPlayers		= CreateConVar("ph_waitforplayers", "0", CVAR_SERVER_ONLY, "Should we wait for players for proper round?", 0, 1 )
PHX.CVAR.MinWaitForPlayers	= CreateConVar("ph_min_waitforplayers", "2", CVAR_SERVER_ONLY_NO_NOTIFY, "Numbers of mininum players that we should wait for round start. Value must not contain less than 1.", 1, game.MaxPlayers())
...
PHX.CVAR.CameraCollision	= CreateConVar("ph_prop_camera_collisions", "1", CVAR_SERVER_ONLY, "Attempts to stop props from viewing inside walls.", 0, 1)
