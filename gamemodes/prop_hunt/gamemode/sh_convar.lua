...
CVAR["ph_custom_taunt_mode"]			=	{ CTYPE_NUMBER, "2", CVAR_SERVER_ONLY, "Enable custom taunts for prop teams by pressing C? (Default 0)\n  You must have a list of custom taunts to enable this.", { min = 0, max = 2 } }
...
CVAR["ph_hunter_kill_bonus"]				=	{ CTYPE_NUMBER, "20", CVAR_SERVER_ONLY, "How much health to give back to the Hunter after killing a prop.", { min = 0, max = 500 } }
...
CVAR["ph_check_props_boundaries"]			=	{ CTYPE_BOOL, 	"1", CVAR_SERVER_ONLY, "Enable prop boundaries/room check? This will prevent you to get stuck with other objects (such as prop, wall, etc)" }
...
CVAR["ph_prop_camera_collisions"]			=	{ CTYPE_BOOL, 	"1", CVAR_SERVER_ONLY, "Attempts to stop props from viewing inside walls." }
